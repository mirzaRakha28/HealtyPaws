<div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
              ...
              <ul class="navbar-nav flex-nowrap ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-list animated--grow-in">
                      ...
                      <a class="dropdown-item d-flex align-items-center" href="#">
                        <div class="dropdown-list-image mr-3">
                          <img class="rounded-circle" src="<?=base_url('')?>assets_dokter/assets/img/avatars/avatar4.jpeg">
                      ...
                      <a class="dropdown-item d-flex align-items-center" href="#">
                        <div class="dropdown-list-image mr-3">
                          <img class="rounded-circle" src="<?=base_url('')?>assets_dokter/assets/img/avatars/avatar2.jpeg">
                      ...
                      <a class="dropdown-item d-flex align-items-center" href="#">
                        <div class="dropdown-list-image mr-3">
                          <img class="rounded-circle" src="<?=base_url('')?>assets_dokter/assets/img/avatars/avatar3.jpeg">
                      ...
                      <a class="dropdown-item d-flex align-items-center" href="#">
                        <div class="dropdown-list-image mr-3">
                          <img class="rounded-circle" src="<?=base_url('')?>assets_dokter/assets/img/avatars/avatar5.jpeg">
                          <div class="bg-success status-indicator">
                          </div>
                        </div>
                        <div class="font-weight-bold">
                ...
                <li class="nav-item dropdown no-arrow">
                  <div class="nav-item dropdown no-arrow">
                    <a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#">
                      <span class="d-none d-lg-inline mr-2 text-gray-600 small">Dolan Trump
                      </span>
                      <img class="border rounded-circle img-profile" src="<?=base_url('')?>assets_dokter/assets/img/avatars/avatar1.jpeg">
                    </a>
          ...
          <div class="container-fluid">
            <h3 class="text-dark mb-4">Pendaftaran Dr. Paws
            </h3>
            <div class="row mb-3" style="height: 400x;">
              <div class="col-lg-4">
                <div class="card mb-3" >
                  <div class="card-body text-center shadow">
                    <div class="mb-3">
                    </div>
                    <img src="<?= base_url()?>assets/img/dokter/<?= $dokter['image']?>" style="width: 200px;">
                  ...
                  <div class="col">
                    <div class="card shadow mb-3">
                      <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Informasi Pribadi
                        </p>
                      </div>
                      <div class="card-body">
                        <form>
            ...
            <div class="card shadow mb-5">
              <div class="card-header py-3">
                <p class="text-primary m-0 font-weight-bold">Jadwal Praktek
                </p>
              </div>
              <div class="card-body">
                <form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form  method="POST" action="<?= base_url('admin_dokter/edit_jadwal')?>">
            <div class="form-group">
            ...
            <div class="form-group">
                <select class="form-control" name="jam_buka" id="sel1">
                    <option>0</option>
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
            ...
            <div class="form-group">
            <select class="form-control" name="jam_tutup" id="sel1">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
            ...
            <div class="form-group">
                <button class="btn btn-primary btn-block" type="submit" style="background: #007fd2;">Save</button>
            </div>
